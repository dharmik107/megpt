...
- **Premium UI**: Modern React-based frontend built with Vite, featuring Glassmorphism, dark mode, and smooth animations.
- **FastAPI Backend**: Robust and scalable backend API for handling chat logic and history.
...
### 4. Launch the AI!
*   **On Windows**: Double-click the `start.bat` file to automatically launch the FastAPI backend and React frontend in separate windows.
*   **Via Command Line**:
    *   To run the Backend: `python -m src.api`
